...
import { 
  Mail, Phone, Linkedin, Github, MapPin, Download, 
  Code, Server, Database, Cloud, Award, Calendar,
  ExternalLink, Briefcase, GraduationCap, Shield, HardDrive
} from 'lucide-react';
...
export default function Resume() {
  ...
  const skills = {
    ...
    "Concepts": {
      items: ["Microservices", "RAG", "VectorDB", "OOP", "SOLID", "DI", "Caching"],
      icon: Award,
      color: "bg-green-50 text-green-700 border-green-200"
    }
  };
    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.div variants={itemVariants} className="mb-8">
              <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-2xl">
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-4 mb-12">
              <a href="mailto:yariv220895@gmail.com" className="flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:bg-white/20">
                <Mail className="w-5 h-5 text-green-400" />
                <span className="text-white">yariv220895@gmail.com</span>
              </a>
              <a href="tel:052-4594598" className="flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:bg-white/20">
                <Phone className="w-5 h-5 text-green-400" />
                <span className="text-white">052-4594598</span>
              </a>
              <a href="https://www.linkedin.com/in/yarivmen/" className="flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:bg-white/20">
                <Linkedin className="w-5 h-5 text-green-400" />
                <span className="text-white">LinkedIn</span>
              </a>
              <a href="https://github.com/yariv245" className="flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:bg-white/20">
              ...
              <Card className="bg-white/10 backdrop-blur-sm shadow-2xl border border-green-500/20">
                <CardContent className="p-12">
                  <p className="text-xl leading-relaxed text-slate-200">
                    Experienced backend developer with <span className="font-semibold text-green-400">3+ years</span> of hands-on experience building scalable systems with Java, Spring Boot, Python, and modern cloud-native technologies. Specializing in REST APIs, microservices, databases (SQL & NoSQL), and AI-integrated features using FastAPI, Neo4j, GraphQL, and ChatGPT/Qdrant for intelligent automation.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
                    ...
                    <Card className="h-full bg-white/10 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 border border-green-500/20">
                      <CardContent className="p-8">
                        <div className="flex items-center gap-3 mb-6">
                          <div className={`p-3 rounded-xl ${data.color.split(' ')[0]} ${data.color.split(' ')[0].replace('50', '100')}`}>
                            <IconComponent className={`w-6 h-6 ${data.color.split(' ').slice(1).join(' ')}`} />
                          </div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            <motion.div variants={itemVariants} className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Featured Project</h2>
            </motion.div>
              ...
              <Card className="bg-white/10 backdrop-blur-sm shadow-2xl hover:shadow-3xl transition-all duration-300 border border-green-500/20">
                <CardContent className="p-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-3xl font-bold text-white">JobSeekerTG Bot</h3>
                    <ExternalLink className="w-5 h-5 text-slate-400 hover:text-green-400 cursor-pointer transition-colors" />
                  </div>
                  
                  <p className="text-lg text-slate-300 mb-6 leading-relaxed">
                    Deployed Telegram bot that scrapes job postings from platforms like 
                    LinkedIn, Indeed, Glassdoor and others. Using Python, MongoDB.
                  </p>
                  
                  <div className="flex flex-wrap gap-2">
                    {["Python", "Telegram API", "MongoDB", "Web Scraping"].map((tech) => (
                      <Badge key={tech} className="bg-green-500/20 text-green-400 hover:bg-green-500/30 transition-colors">
                        {tech}
                      </Badge>
                    ))}
                  </div>
                ...
                <Card className="h-full bg-white/10 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 border border-green-500/20">
                  <CardContent className="p-8">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-white">Military Service</h3>
                    </div>
        ...
        <footer className="py-12 px-6 bg-slate-800 border-t border-green-500/20">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg mb-4 text-slate-300">Ready to build something amazing together?</p>
            <div className="flex justify-center gap-6">
              <a href="mailto:yariv220895@gmail.com" className="hover:text-green-400 transition-colors text-slate-400">
                <Mail className="w-6 h-6" />
              </a>
              <a href="https://www.linkedin.com/in/yarivmen/" className="hover:text-green-400 transition-colors text-slate-400">
                <Linkedin className="w-6 h-6" />
              </a>
              <a href="https://github.com/yariv245" className="hover:text-green-400 transition-colors text-slate-400">
